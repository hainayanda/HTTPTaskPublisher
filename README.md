...
- Set rules to **version**, with the **Up to Next Major** option option and use **2.0.1** as the version.
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/HTTPTaskPublisher.git", .upToNextMajor(from: "2.0.1"))
]
```
